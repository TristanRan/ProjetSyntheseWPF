...
namespace SalariesDll
{
    ...
    public class Salarie : INotifyPropertyChanged
    {
        ...
        private string _poste = string.Empty;
        ...
        protected void OnPropertyChanged(string propertySalaireNet)
        {

            PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(propertySalaireNet));
        ...
        public override string ToString()
        {
            ...
            return string.Format(CultureInfo.CurrentCulture, @"{0};{1};{2};{3:# ###.##};{4};{5:d};{6}", this._matricule, this._nom, this._prenom, this._salaireBrut, this._tauxCS, this._dateNaissance.Date, this.SalaireNet);
        }
        /// <summary>
